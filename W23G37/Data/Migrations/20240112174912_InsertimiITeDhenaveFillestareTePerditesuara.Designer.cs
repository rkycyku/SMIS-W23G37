...
namespace W23G37.Data.Migrations
{
    ...
    [Migration("20240112174912_InsertimiITeDhenaveFillestareTePerditesuara")]
    partial class InsertimiITeDhenaveFillestareTePerditesuara
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("W23G37.Models.Pagesat", b =>
                {
                    ...
                    b.Property<string>("KestiPageses")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("W23G37.Models.TarifaStudenti", b =>
                {
                    b.Property<int>("ZbritjaStudentiID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ZbritjaStudentiID"), 1L, 1);
                    ...
                    b.Property<double?>("TarifaFikse")
                        .HasColumnType("float");

                    b.Property<int?>("TarifaStudimitID")
                        .HasColumnType("int");

                    b.Property<int?>("Zbritja1ID")
                        .HasColumnType("int");

                    b.Property<int?>("Zbritja2ID")
                        .HasColumnType("int");

                    b.HasKey("ZbritjaStudentiID");

                    b.HasIndex("StudentiID");

                    b.HasIndex("TarifaStudimitID");

                    b.HasIndex("Zbritja1ID");

                    b.HasIndex("Zbritja2ID");

                    b.ToTable("TarifaStudenti");
                });
            ...
            modelBuilder.Entity("W23G37.Models.TarifatDepartamenti", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TarifaID"), 1L, 1);
                    ...
                    b.Property<double?>("TarifaVjetore")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("W23G37.Models.Zbritjet", b =>
                {
                    b.Property<int>("ZbritjaID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("W23G37.Models.TarifaStudenti", b =>
                {
                    ...
                    b.HasOne("W23G37.Models.TarifatDepartamenti", "TarifaStudimit")
                        .WithMany()
                        .HasForeignKey("TarifaStudimitID");

                    b.HasOne("W23G37.Models.Zbritjet", "Zbritja1")
                        .WithMany()
                        .HasForeignKey("Zbritja1ID");

                    b.HasOne("W23G37.Models.Zbritjet", "Zbritja2")
                        .WithMany()
                        .HasForeignKey("Zbritja2ID");

                    b.Navigation("Studenti");

                    b.Navigation("TarifaStudimit");

                    b.Navigation("Zbritja1");

                    b.Navigation("Zbritja2");
                });
