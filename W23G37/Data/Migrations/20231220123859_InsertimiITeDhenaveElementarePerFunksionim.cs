...
{
    public partial class InsertimiITeDhenaveElementarePerFunksionim : Migration
    {
    ...
    {
        "02020202-0202-0202-0202-020202020202","ss6@ubt-uni.net", "SS6@UBT-UNI.NET",
        "ss6@ubt-uni.net","SS6@UBT-UNI.NET", false,
        "AQAAAAEAACcQAAAAEEP+vx1+ZqfEnVVVAGWewBOTXWcXeD4Y6SVKOMk2FesDA1EKAEuNP4NwoLQ4CGdjgQ==",
    ...
    },
    {
        ...
        null, false, false, null, true, 0
            ...
            { 2, "Student", "Student", "ss6@ubt-uni.net", "ss6", "02020202-0202-0202-0202-020202020202" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
            { 1, "38344111222", "Prishtine", "10000", "P.A.", "Kosove", 1 },
            { 2, "38344111222", "Prishtine", "10000", "P.A.", "Kosove", 2 },
            { 3, "38344111222", "Prishtine", "10000", "P.A.", "Kosove", 3 },
            { 4, "38344111222", "Prishtine", "10000", "P.A.", "Kosove", 4 },
            { 5, "38344111222", "Prishtine", "10000", "P.A.", "Kosove", 5 },
            { 6, "38344111222", "Prishtine", "10000", "P.A.", "Kosove", 6 }
                });
            ...
            migrationBuilder.InsertData(
               ...
               columns: new[] { "TDhRSID", "KodiFinanciar", "DepartamentiID", "NiveliStudimitID", "VitiAkademikRegjistrim", "DataRegjistrimit", "LlojiRegjistrimit", "SpecializimiID", "UserId" },
               values: new object[,]
               {
            { 1, "010100001",1, 1, "2023/2024", "2023-12-20T11:28:49.762Z", "I Rregullt", null, 2 }
               });
